...
{
    /// <summary>
    /// A dictionary that is aware of command line input patterns. All lookups for keys ignore case.
    /// </summary>
    /// <example>
    /// This is a sample for parsing the following command line:
    ...
    */
    ...
    public class CommandLineDictionary : Dictionary<string, string>
    {
        ...
        private void AddArgument(string argument)
        {
            ...
            {
                //EDIT: changed split to only split on in two parts based on the key character. 
                // File Paths and urls are no longer chopped.
                string[] splitArg = argument.Substring(1).Split(new [] {ValueCharacter},2);
